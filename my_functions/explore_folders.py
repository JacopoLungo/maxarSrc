...
def create_pre_post_diz_set(event_id, root = '/mnt/data2/vaschetti_data/maxar/'):
    """
...
def check_matching_pre_post(event_id, root = '/mnt/data2/vaschetti_data/maxar/', verbose=True):
    """
    Params:
...
def compute_stats_on_event(event_id, root = '/mnt/data2/vaschetti_data/maxar/'):
    """
    Params:
    event_id: Example: "Gambia-flooding-8-11-2022"
