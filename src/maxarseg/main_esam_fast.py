...
def main(): 
    ...
    parser.add_argument('--size_seg', default = 1024, type = int, help = 'Size of the patch') #TODO: se viene usato evit allora questo parametro viene disattivato
    parser.add_argument('--stride_seg', default = 1024, type = int, help = 'Stride of the patch')
    ...
    parser.add_argument('--out_dir_root', default = "./output/tiff/esam_fast", help='output directory root')
    ...
    #FIXME: for debug event.seg_all_mosaics(out_dir_root=args.out_dir_root) #this segment all the mosiacs in the event
    ...
    m0_tile_17_path = m0.tiles_paths[2]
    m0.segment_tile(m0_tile_17_path, args.out_dir_root, seg_type = 'evit', separate_masks = False)
