...
def main(): 
    ...
    m0_tile_path = m0.tiles_paths[2]
    print('Evento: ', event.name)
    print('Mosaico: ', m0.name)
    print('Tile: ', m0_tile_path)
    
    m0.segment_tile(m0_tile_path, args.out_dir_root, seg_type = 'evit', separate_masks = False)
